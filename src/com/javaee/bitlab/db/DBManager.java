...
public class DBManager {
    ...
    static {
        ...
        tasks.add(new Task(1L, "Gym", "Состояние ответа на задание\tОтветы на задание еще не представлены", false, "2023-07-21"));
        tasks.add(new Task(2L, "Swimming", "Щитник серый, или элазмуха берёзовая, или эласмуха берёзовая (лат.  ), — вид клопов рода  из семейства древесных щитников (array). Широко распространённый и обычный лесной палеарктический вид. Встречается от Европы до Сибири и Дальнего", false, "2023-04-11"));
        tasks.add(new Task(3L, "Ready to book", "Востока, а также в Закавказье, Турции, Казахстане, Монголии и Китае. Клопы среднего размера, длина тела имаго может достигать 6—9 миллиметров. Окраска варьирует: красновато-коричневая, серо-зелёная с тёмными отметинами. Самцы меньше самок. Питаются на различных древесных растениях, в том числе на берёзе, ольхе, буке, падубе, ели и других. Высасывают соки плодов и семян, в результате чего снижается их всхожесть.", false, "2023-05-21"));
        tasks.add(new Task(4L, "CS:GO", "Для вида зафиксирована материнская забота (поведение по охране яиц и личинок-нимф). После яйцекладки самка стоит над кладкой яиц и защищает её на протяжении всего развития яиц. Репертуар защитного поведения самок, стоящих над пакетом яиц, включает в себя взмахи крыльями", false, "2023-01-23"));
    }
